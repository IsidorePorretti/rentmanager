...
public class ClientUpdateServlet extends HttpServlet {
	...
	/**
	 * @return le doGet de ClientUpdateServlet
	 */
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// TODO Auto-generated method stub
							
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/WEB-INF/views/clients/update.jsp");
	...
	/**
	 * @return le doPost de ClientUpdateServlet
	 */
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			client.setNom(req.getParameter("last_name")); 
