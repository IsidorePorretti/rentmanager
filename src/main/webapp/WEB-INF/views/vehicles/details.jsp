                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <h3 class="profile-vehicle text-center"> 
                                       ${vehicle.constructeur}  ${vehicle.modele}  (${vehicle.nb_places})
							</h3>
							
                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>Reservation(s)</b> <a class="pull-right">
                                    	${nombre_reservations}
                                    </a>
                                </li>
                                <li class="list-group-item">
                                    <b>Clients(s)</b> <a class="pull-right">
                                   		${nombre_clients}
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="col-md-8">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#clients" data-toggle="tab">Détails des clients</a></li>
                        </ul>
